  ...
  self.runCommand = function runCommand (command, yargs, parsed, commandIndex, callback) {
    ...
    if (typeof commandHandler.builder === 'function') {
      ...
      if (yargs.parsed === false) {
        ...
        innerArgv = innerYargs ? innerYargs._parseArgs(null, null, true, commandIndex, callback) : yargs._parseArgs(null, null, true, commandIndex, callback)
      } else {
      ...
      innerArgv = innerYargs._parseArgs(null, null, true, commandIndex, callback)
